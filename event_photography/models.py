...
class P_Category(models.Model):
    ...
    PID=models.ForeignKey(Photo_DB,on_delete=models.CASCADE,default='1')

    def save(self):
        self.slug=slugify(self.name)
        super(P_Category,self).save()  
...
class P_Product(models.Model):
    ...
    CaterID=models.ForeignKey(Photo_DB,on_delete=models.CASCADE,default='1')
...
class P_image(models.Model):
    ProductID=models.ForeignKey(P_Product,on_delete=models.CASCADE,default='1')
    Image=models.ImageField(upload_to='cater')
    
class P_book(models.Model):
    username=models.CharField(max_length=20)
    number=models.CharField(max_length=50)
    email=models.EmailField(max_length=50)
    prodid=models.CharField(max_length=20,default="0")
    photoid=models.CharField(max_length=20,default="0")
    userid=models.CharField(max_length=20,default="0")
